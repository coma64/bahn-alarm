...
export class AlarmsService {
  ...
  public alarmsGet(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<AlarmsList>>;
  public alarmsGet(
    page?: number,
    size?: number,
    urgency?: Urgency,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<AlarmsList>>;
  public alarmsGet(
    page?: number,
    size?: number,
    urgency?: Urgency,
    ...
    return this.httpClient.request<AlarmsList>(
      'get',
  ...
  public alarmsIdDelete(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling alarmsIdDelete.',
      );
    }
    ...
    let localVarPath = `/alarms/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
