 ...
 */
import { TrackingStatsNextDeparture } from './trackingStatsNextDeparture';

export interface TrackingStats {
  totalConnectionCount: number;
  delayedConnectionCount: number;
  canceledConnectionCount: number;
  nextDeparture: TrackingStatsNextDeparture;
}
